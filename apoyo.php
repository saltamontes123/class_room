...
<script>
		...
		output.value =latitude+" "+longitude;
			...
			function error(){
				output.value = "No se pudo obtener la ubicación";
			}
			navigator.geolocation.getCurrentPosition(localizacion,error);
		}
	</script>
<!-- hasta aqui para obtener la ubicacion  -->
        ...
        <body>
          ...
          <!--          </div>
                ...
                <div class="row cuerpo" style="margin-bottom: 0px;">
                  <br><br>
                  <h3 class="texto1 center">Si requieres ayuda ingresa tus datos</h3>
                  <div class="col l8 offset-l2 inscripcion texto0">
                    <br><br>
                     <form id="formulario" action="php/agregarusuario.php" method="post">
                      ...
                      <input class="mi_input form-control" type="email" id="email" name="email" placeholder="E-mail"><br>
                      ...
                      <input class="mi_input" type="text" id="celular" name="celular" placeholder="Número de celular"><br>
											<label for="redes_sociales">Sexo</label>
											<select name="sexo" class="browser-default input-field">
												<option value="-1">-- Seleccionar sexo --</option>
												<option value = "1">Femenino</option>
												<option value = "0">Masculino</option>
											</select>
											<input class="mi_input" type="text" id="ocupacion" name="ocupacion" placeholder="Ocupación">
                      <label for="">País</label>
                        ...
                        <select name="region" id="region" class="browser-default input-field"></select>
						<input class="mi_input" type="text" id="zona" name="zona" placeholder="Zona / Barrio">
						<input type="text" id="coordenadas" name="coordenadas" onclick="findMe();" placeholder="Coordenadas" title="Latitud Longitud">
